/* SAUD — Kuwait Fighter
   ...
   ========================================================================== */
/* Skin and hair, 2026-09-24. Skin is measured skin, not a swatch: each man
   kept his place from light to dark, and was given the chroma and hue of
   real skin (CIELAB a* 12-15, b* 19-22, hue 53-61 degrees) instead of the
   orange he had (chroma 31-40). The two pairs that shared a colour -- the
   Brawler and the Enforcer, the Kickboxer and AL-SAQR -- now differ in
   undertone. `hairStyle` is the cut (the browser draws it; Unreal builds it,
   Tools/blender/hero/assembly.py): quiff, crop, buzz, fade, curly, slick,
   part, fringe. `grey` is how grey he is at the temples, 0..1. The
   Brawler's hair and beard carry henna. */
window.ASSET_ENEMIES = {
  thug:    {hp:46,  pow:.80, spd:120, reach:54, rate:1.55, xp:14, sc:1.00,
            moves:['jab','cross'], name:'Souq Thug', ar:'بلطجي',
            col:{skin:'#a57a61', top:'#8a9099', bottom:'#2f3a4d', band:'#8d99ab'},
            look:{ build:0.90, tee:true, pants:true, hands:'bare', hair:'#171310', hairStyle:'buzz' }},
  brawler: {hp:68,  pow:1.00, spd:132, reach:58, rate:1.25, xp:21, sc:1.05,
            moves:['jab','cross','hook'], name:'Brawler', ar:'مشاكس',
            col:{skin:'#9a6f57', top:'#8c4a34', bottom:'#3a2f28', band:'#c8102e'},
            look:{ build:1.12, tee:true, pants:true, hands:'bare', beard:'rgba(61,31,19,.85)', hair:'#3d1f13', hairStyle:'curly' }},
  kicker:  {hp:60,  pow:1.15, spd:162, reach:74, rate:1.10, xp:26, sc:1.02,
            moves:['kick','jab','kick','cross'], name:'Kickboxer', ar:'ركّال',
            col:{skin:'#b1866b', top:'#1f8a63', bottom:'#232a36', band:'#e0b34a'},
            look:{ build:0.98, tee:true, pants:true, hoodie:true, stripe:true, hands:'wraps', hair:'#1b1511', hairStyle:'fade' }},
  grappler:{hp:110, pow:1.35, spd:98,  reach:46, rate:1.75, xp:34, sc:1.18,
            moves:['knee','hook','knee'], name:'Grappler', ar:'مصارع',
            col:{skin:'#90664f', top:'#6b7280', bottom:'#26292f', band:'#7d8794'},
  ...
  champ:   {hp:160, pow:1.35, spd:152, reach:68, rate:0.95, xp:52, sc:1.10,
            ...
            col:{skin:'#a47a5e', top:'#6b3bb0', bottom:'#22243a', band:'#e0b34a'},
            look:{ build:1.14, tee:true, pants:true, jacket:true, hands:'wraps', hair:'#1d1712', hairStyle:'slick', grey:.45, beard:'rgba(26,18,12,.7)' }},
  runner:  {hp:42,  pow:0.85, spd:210, reach:56, rate:0.85, xp:22, sc:0.94,
            moves:['jab','jab','cross'], name:'Snatcher', ar:'خطّاف', hitRun:true,
            col:{skin:'#b58b6e', top:'#e07b2c', bottom:'#2c3550', band:'#ffd166'},
            look:{ build:0.88, tee:true, pants:true, hoodie:true, hands:'bare', cap:'#d4762b', hair:'#2b1d13', hairStyle:'crop' }},
  bouncer: {hp:150, pow:1.30, spd:104, reach:52, rate:1.90, xp:40, sc:1.24,
            moves:['hook','knee','hook'], name:'Bouncer', ar:'حارس', wall:true,
            col:{skin:'#845b45', top:'#191d24', bottom:'#12151a', band:'#5aa9e6'},
  ...
  capo:    {hp:118, pow:1.20, spd:168, reach:64, rate:0.78, xp:44, sc:1.06,
            ...
            col:{skin:'#946c50', top:'#1f6a80', bottom:'#1a2230', band:'#8fd3ff'},
            look:{ build:1.08, tee:true, pants:true, jacket:true, hands:'bare', hair:'#141110', hairStyle:'part', grey:.22, shades:true }},
  boss:    {hp:430, pow:1.45, spd:146, reach:72, rate:0.88, xp:220, sc:1.26,
            moves:['jab','cross','hook','kick','knee'], name:'AL-WAHSH', ar:'الوحش',
            col:{skin:'#885e47', top:'#1b1f26', bottom:'#101318', band:'#c8102e'},
  ...
  saqr:    {hp:290, pow:1.30, spd:186, reach:76, rate:0.80, xp:150, sc:1.14,
            ...
            col:{skin:'#ab7f67', top:'#2c4a8a', bottom:'#20242e', band:'#e8e2d4'},
            look:{ build:1.12, tee:true, pants:true, hoodie:true, stripe:true, hands:'wraps', hair:'#221813', hairStyle:'fringe' }},
  ...
  zayos:   {hp:300, pow:1.35, spd:108, reach:78, rate:1.15, xp:130, sc:1.55,
            ...
            col:{skin:'#79503b', top:'#1a1216', bottom:'#0f0c10', band:'#c8102e'},
