...
and screentone instead of gradients. Saud is drawn the way an anime poster
...
# than a face -- goggles on the bosses, a cyclops slit on Saud. The cause was
...
# call works on ZAYOS's 62-unit skull and on the falling Saud's 42-unit one.
...
def saud_cross(ink="#090b0f", cloth="#21283f", tone="#2d3448", rim="#e5b750",
...
def saud_falling(x, y, s=1.0, rot=24, ink="#090b0f", rim="#e5b750", wrap="#cd1932"):
