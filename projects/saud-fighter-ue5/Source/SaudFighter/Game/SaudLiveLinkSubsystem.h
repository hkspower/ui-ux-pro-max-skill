...
#include "SaudLiveLinkSubsystem.generated.h"
 ...
 *
 * USaudConfigSubsystem pulls the tables at launch and whenever it is asked.
 ...
 * [/Script/SaudFighter.SaudLiveLinkSubsystem].
 */
UCLASS(Config = Game)
class SAUDFIGHTER_API USaudLiveLinkSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
