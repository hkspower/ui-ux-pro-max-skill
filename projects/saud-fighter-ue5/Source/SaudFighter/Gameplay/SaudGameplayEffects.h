...
#include "SaudGameplayEffects.generated.h"
...
UCLASS()
class SAUDFIGHTER_API UGE_SaudDamage : public UGameplayEffect
{
	GENERATED_BODY()
public:
	UGE_SaudDamage();
...
UCLASS()
class SAUDFIGHTER_API UGE_SaudAttackCost : public UGameplayEffect
{
	GENERATED_BODY()
public:
	UGE_SaudAttackCost();
...
UCLASS()
class SAUDFIGHTER_API UGE_SaudDefaultAttributes : public UGameplayEffect
{
	GENERATED_BODY()
public:
	UGE_SaudDefaultAttributes();
};

/** Stamina and mana coming back over time. Infinite, applied at spawn. */
UCLASS()
class SAUDFIGHTER_API UGE_SaudRegeneration : public UGameplayEffect
{
	GENERATED_BODY()
public:
	UGE_SaudRegeneration();
};
...
class SAUDFIGHTER_API USaudCueNotify_Impact : public UGameplayCueNotify_Static
{
	GENERATED_BODY()
