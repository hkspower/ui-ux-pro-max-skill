...
#include "SaudTraversalAbilities.generated.h"
 ...
 */
UCLASS()
class SAUDFIGHTER_API USaudDashAbility : public USaudGameplayAbility
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SAUDFIGHTER_API USaudGuardAbility : public USaudGameplayAbility
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SAUDFIGHTER_API USaudJumpAbility : public USaudGameplayAbility
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SAUDFIGHTER_API USaudClimbAbility : public USaudGameplayAbility
{
	GENERATED_BODY()
