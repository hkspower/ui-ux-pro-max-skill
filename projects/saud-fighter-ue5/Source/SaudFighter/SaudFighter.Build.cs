...
public class SaudFighter : ModuleRules
{
	public SaudFighter(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[]
		{
			...
			// retune reaches a running game. Game/SaudLiveLinkSubsystem.h.
			"WebSockets"
		});
