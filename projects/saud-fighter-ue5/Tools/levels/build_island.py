...
`../saud-fighter/CLAUDE.md` is intact.
...
# Duplicated from Combat/SaudArena.h and Tools/fab/lay_out_world.py on
...
def extent_of(stage):
    """SaudArena::DistrictExtent, in Python."""
...
def terrain(stage, E, phase, doors, into):
    ...
    #     E - EXIT_MARGIN, where ASaudGameMode::PlaceArrivingPlayer and
...
def check(P):
    ...
    #     their role fixes. ASaudGameMode::PlaceArrivingPlayer computes the
