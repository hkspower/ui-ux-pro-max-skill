"""SAUD — Kuwait Fighter :: tables -> Data Assets
==============================================================================
...
What it decides that the CSV cannot:
  ...
  Saud.Attack.Box.Jab, which is a family AND an identity in one value, and
...
ATTACK_TAGS = {
    "Jab":     "Saud.Attack.Box.Jab",
    "Cross":   "Saud.Attack.Box.Cross",
    "Hook":    "Saud.Attack.Box.Hook",
    "Kick":    "Saud.Attack.Kick.Roundhouse",
    "Knee":    "Saud.Attack.Kick.Knee",
    "Special": "Saud.Attack.Rage",
}
TALENT_TAGS = {
    "Vault":     "Saud.Talent.Vault",
    "DashLeap":  "Saud.Talent.DashLeap",
    "PowerKick": "Saud.Talent.PowerKick",
    "Haymaker":  "Saud.Talent.Haymaker",
    "HawkFist":  "Saud.Talent.HawkFist",
    ...
    "Jump":      "Saud.Talent.Jump",
    "Climb":     "Saud.Talent.Climb",
}
    ...
    for row in read("DT_Attacks.csv"):
        ...
        if not tag:
            raise SystemExit(
                ...
                "SaudGameplayTags.h, then re-run." % name)
        ...
        out.append(dict(
            ...
            WhooshCue="Saud.Cue.Whoosh.Heavy" if heavy else "Saud.Cue.Whoosh.Light",
            ImpactCue="Saud.Cue.Hit.Heavy" if heavy else "Saud.Cue.Hit.Light",
...
def build(attacks, talents, styles):
    ...
    for a in attacks:
        asset = make(a["asset"], unreal.SaudAttackData)
    ...
    for t in talents:
        asset = make(t["asset"], unreal.SaudTalentData)
    ...
    for st in styles:
        asset = make(st["asset"], unreal.SaudFightStyleData)
