#!/usr/bin/env bash
# SAUD — Kuwait Fighter :: build and package for iOS, from a Mac
# =============================================================================
...
PROJECT="$PROJECT_DIR/SaudFighter.uproject"
...
[[ -f "$PROJECT" ]] || die "SaudFighter.uproject not found at $PROJECT"
...
echo "  ios-deploy --bundle Build/IOS/SaudFighter.ipa      (brew install ios-deploy)"
