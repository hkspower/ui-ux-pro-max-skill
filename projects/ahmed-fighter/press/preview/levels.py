#!/usr/bin/env python3
"""AHMED preview booklet -- black and white levels.
...
PAIRS = [
    ...
    (("#06080d", "figure"), ("#242031", None), "Ahmed's ink vs his lit cheek"),
    (("#06080d", "figure"), ("#161d33", None), "Ahmed's ink vs his vest"),
